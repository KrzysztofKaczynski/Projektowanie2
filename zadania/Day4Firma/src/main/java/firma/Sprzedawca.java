...
public class Sprzedawca extends PracownikWydzialu{
   ...
   private List<Projekt> sellApp = new ArrayList<>();
    ...
    public Sprzedawca(int id, String imie, String nazwisko, LocalDate localDate, double zarobki, double premia, String stanowisko, List<Projekt> sellApp, double sellAppPrice) {
